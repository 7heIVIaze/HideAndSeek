...
void ALamp_cpp::BeginPlay()
{
	...
	//		FOnTimelineFloat TimelineProgress;
	//		TimelineProgress.BindDynamic(this, &ALamp_cpp::LightFlicker);
	//		FlickeringLightTimeline.AddInterpFloat(CurveFloat, TimelineProgress);
	//		FlickeringLightTimeline.SetLooping(true);
	//	}
	//}
}
...
/*void ALamp_cpp::OnInteract(class AHorrorGameCharacter* Player)
{
...
//			if (bIsLightBlink)
//			{
//				if (YokaiNearNum > 0 && !bIsNaturalFlick)
//				{
//					FlickeringLightTimeline.Play();
//				}
//			}
