...
ACigarLighter::ACigarLighter()
{
 ...
 //	// Set this actor to call Tick() every frame.  You can turn this off to improve performance if you don't need it.
	...
	//	CigarLightOnSound->OnAudioFinished.AddDynamic(this, &ACigarLighter::CigarLightOn);
	//}
	//
...
//void ACigarLighter::OnInteract(class AHorrorGameCharacter* Player)
//{
...
//				Player->SetArchiveGetText(NSLOCTEXT("ACigarLighter", "Get_Lighter", "Lighter\nis added in archive"));
//				SaveData->SaveData();
//			}
//		}
//
...
//}
//
//void ACigarLighter::UseInteract(class AHorrorGameCharacter* Player)
//{
...
// Deprecated
//void ACigarLighter::CigarLightOn()
//{
