...
//void AMirror::OnInteract(class AHorrorGameCharacter* Player)
//{
...
//				Player->SetArchiveGetText(NSLOCTEXT("AMirror", "Get_Mirror", "Bronze Mirror\nis added in archive"));
//				SaveData->SaveData();
//			}
//		}
//
...
//void AMirror::UseInteract(class AHorrorGameCharacter* Player)
//{
